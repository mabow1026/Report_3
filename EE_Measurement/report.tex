...
\begin{thebibliography}{9}%参考文献数が10以上の場合は9を99に変更
	...
	\bibitem{cds} ３分でわかる技術の超キホン CdSセルとは？原理と電子回路での使い方を解説！ \url{https://engineer-education.com/cds-cell/}
	\bibitem{power} ひずみゲージ入門 \url{https://www.kyowa-ei.com/jpn/technical/strainbasic_course/index.html}
\end{thebibliography}
